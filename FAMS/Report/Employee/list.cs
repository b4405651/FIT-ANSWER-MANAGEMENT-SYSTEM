...
namespace FAMS.Report.Employee
{
    public partial class list : Form
    {
        ...
        public list()
        {
            ...
            wb = new webBrowser(wb_panel); wb.DocumentText = "<center style='font-size: 24px; font-family:\'Tahoma\'; height: 100%; valign: middle;'><b><u>รายงาน รายชื่อ และ รายได้ ของ พนักงานทั่วไป</u></b></center>";
        }
        ...
        private void manage_btn_Click(object sender, EventArgs e)
        {
            ...
            Dictionary<String, Object> Obj = DB.ReportGetTotalRecord("Employee/ListEmployee", values);
            ...
            DB.PerformWebNavigate("Employee/ListEmployee", wb, values);
        }
        ...
        private void excel_btn_Click(object sender, EventArgs e)
        {
            ...
            DB.WebDownload(this, "Employee/ListEmployee", "employee_list.xls", values);
        }
    }
}
