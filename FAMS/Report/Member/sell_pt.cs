...
{
    public partial class sell_pt : Form
    {
        ...
        public sell_pt()
        {
            ...
            wb = new webBrowser(wb_panel); wb.DocumentText = "<center style='font-size: 24px; font-family:\'Tahoma\'; height: 100%; valign: middle;'><b><u>รายงาน การขาย PT</u></b></center>";
        }
        ...
        private void manage_btn_Click(object sender, EventArgs e)
        {
            ...
            DB.PerformWebNavigate("Member/SellPT/", wb, values);
        }
        ...
        private void excel_btn_Click(object sender, EventArgs e)
        {
            ...
            DB.WebDownload(this, "Member/SellPT/", "sell_pt.xls", values);
        }
    }
}
