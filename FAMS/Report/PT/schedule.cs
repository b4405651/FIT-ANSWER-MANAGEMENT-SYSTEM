...
namespace FAMS.Report.PT
{
    public partial class schedule : Form
    {
        ...
        public schedule()
        {
            ...
            wb = new webBrowser(wb_panel); wb.DocumentText = "<center style='font-size: 24px; font-family:\'Tahoma\'; height: 100%; valign: middle;'><b><u>รายงาน ตารางการทำงานเทรนเนอร์</u></b></center>";
        }
        ...
        private void manage_btn_Click(object sender, EventArgs e)
        {
            ...
            Dictionary<String, Object> Obj = DB.ReportGetTotalRecord("PT/Schedule", values);
            ...
            DB.PerformWebNavigate("PT/Schedule", wb, values);
        }
        ...
        private void excel_btn_Click(object sender, EventArgs e)
        {
            ...
            DB.WebDownload(this, "PT/Schedule", "pt_schedule.xls", values);
        }
    }
}
