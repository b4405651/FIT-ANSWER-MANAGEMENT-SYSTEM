...
namespace FAMS.Report.Shop
{
    public partial class revenue : Form
    {
        ...
        public revenue()
        {
            ...
            wb = new webBrowser(wb_panel); wb.DocumentText = "<center style='font-size: 24px; font-family:\'Tahoma\'; height: 100%; valign: middle;'><b><u>รายงาน ยอดขายสินค้าสะสม</u></b></center>";
        }
        ...
        private void manage_btn_Click(object sender, EventArgs e)
        {
            ...
            DB.PerformWebNavigate("Shop/Revenue", wb, values);
        }
        ...
        private void excel_btn_Click(object sender, EventArgs e)
        {
            ...
            DB.WebDownload(this, "Shop/Revenue", "shop_revenue.xls", values);
        }
    }
}
