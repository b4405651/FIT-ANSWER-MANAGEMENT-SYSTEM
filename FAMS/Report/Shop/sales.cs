...
namespace FAMS.Report.Shop
{
    public partial class sales : Form
    {
        ...
        public sales()
        {
            ...
            wb = new webBrowser(wb_panel); wb.DocumentText = "<center style='font-size: 24px; font-family:\'Tahoma\'; height: 100%; valign: middle;'><b><u>รายงาน ยอดขายสินค้า ณ วันที่</u></b></center>";
        }
        ...
        private void manage_btn_Click(object sender, EventArgs e)
        {
            ...
            DB.PerformWebNavigate("Shop/Sales", wb, values);
        }
        ...
        private void excel_btn_Click(object sender, EventArgs e)
        {
            ...
            DB.WebDownload(this, "Shop/Sales", "shop_sales.xls", values);
        }
    }
}
