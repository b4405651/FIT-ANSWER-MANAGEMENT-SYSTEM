...
namespace FAMS.Report.Stock
{
    public partial class balance : Form
    {
        ...
        public balance()
        {
            ...
            wb = new webBrowser(wb_panel); wb.DocumentText = "<center style='font-size: 24px; font-family:\'Tahoma\'; height: 100%; valign: middle;'><b><u>รายงาน จำนวนสินค้าคงเหลือ</u></b></center>";
        }
        ...
        private void manage_btn_Click(object sender, EventArgs e)
        {
            ...
            Dictionary<String, Object> Obj = DB.ReportGetTotalRecord("Stock/Balance", values);
            ...
            DB.PerformWebNavigate("Stock/Balance", wb, values);
        }
        ...
        private void excel_btn_Click(object sender, EventArgs e)
        {
            ...
            DB.WebDownload(this, "Stock/Balance", "product_balance.xls", values);
        }
    }
}
