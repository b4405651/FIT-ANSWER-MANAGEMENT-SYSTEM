...
{
    public partial class DuringDate : Form
    {
        ...
        public DuringDate()
        {
            ...
            wb = new webBrowser(wb_panel); wb.DocumentText = "<center style='font-size: 24px; font-family:\'Tahoma\'; height: 100%; valign: middle;'><b><u>รายงาน รายได้สาขา ระหว่างวันที่</u></b></center>";
        }
        ...
        private void manage_btn_Click(object sender, EventArgs e)
        {
            ...
            DB.PerformWebNavigate("Summary", wb, values);
        }
        ...
        private void excel_btn_Click(object sender, EventArgs e)
        {
            ...
            DB.WebDownload(this, "Summary/DuringDate", "summary_during_date.xls", values);
        }
    }
}
