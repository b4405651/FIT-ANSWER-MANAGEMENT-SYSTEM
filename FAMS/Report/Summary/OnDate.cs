...
{
    public partial class OnDate : Form
    {
        ...
        public OnDate()
        {
            ...
            wb = new webBrowser(wb_panel); wb.DocumentText = "<center style='font-size: 24px; font-family:\'Tahoma\'; height: 100%; valign: middle;'><b><u>รายงาน รายได้ ณ วันที่ และ สะสม</u></b></center>";
        }
        ...
        private void manage_btn_Click(object sender, EventArgs e)
        {
            ...
            DB.PerformWebNavigate("Summary/OnDate", wb, values);
        }
        ...
        private void excel_btn_Click(object sender, EventArgs e)
        {
            ...
            DB.WebDownload(this, "Summary/OnDate", "summary_on_date.xls", values);
        }
    }
}
