...
namespace FAMS
{
    public partial class config_member_type : Form
    {
        public config_member_type()
        {
            InitializeComponent();
            ...
            DGVC.Add(new dgvColumn("member_name", "ชื่อประเภทสมาชิก", DataGridViewContentAlignment.MiddleLeft));
            DGVC.Add(new dgvColumn("month", "อายุ ( เดือน )"));
            ...
            DGVC.Add(new dgvColumn("suspend_by", "โดย", DataGridViewContentAlignment.MiddleLeft));
            DGVC.Add(new dgvColumn("member_type_id", "member_type_id", DataGridViewContentAlignment.BottomCenter, false));
        ...
        {
            using (config_member_type_manage configMemberManage = new config_member_type_manage())
            {
                configMemberManage.member_type_id = btn_dgv.DGV.SelectedRows[0].Cells["member_type_id"].Value.ToString();
                configMemberManage.Owner = this;
                configMemberManage.ShowDialog();
                this.BringToFront();
            }
        }
        ...
        void DisableEvent(object sender, EventArgs e)
        {
            ...
            {
                { "member_type_id", btn_dgv.DGV.SelectedRows[0].Cells["member_type_id"].Value.ToString() },
                { "suspend_by_user_id", GF.userID }
            };

            GF.showLoading(this);
            Dictionary<String, Object> result = DB.Post("MemberType/MemberTypeSuspend/", values);
        ...
        void EnableEvent(object sender, EventArgs e)
        {
            ...
            GF.showLoading(this);
            Dictionary<String, Object> result = DB.Post("MemberType/MemberTypeEnable/", values);
