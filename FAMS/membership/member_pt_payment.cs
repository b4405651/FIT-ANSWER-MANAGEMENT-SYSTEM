...
namespace FAMS
{
    public partial class member_pt_payment : Form
    {
        public int max_amount = 0;
        public member_pt_payment()
        {
            InitializeComponent();
        ...
        private void manage_btn_Click(object sender, EventArgs e)
        {
            ...
            String[] Data = {
                ...
                "",
                "",
                (payment_type.SelectedItem as ComboItem).Key.ToString()
            };
            ...
            GF.addPaymentRow((this.Owner as member_pt).payment_DGV, Data, (payment_type.SelectedItem as ComboItem).Key.ToString());
