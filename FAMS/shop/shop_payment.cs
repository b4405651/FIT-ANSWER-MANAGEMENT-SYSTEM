...
namespace FAMS
{
    public partial class shop_payment : Form
    {
        ...
        private void manage_btn_Click(object sender, EventArgs e)
        {
            ...
            if (payment_type.SelectedIndex == 1)
            {
                DGV.Rows[DGV.Rows.Count - 1].Cells[2].Value = card_no.Text;
                DGV.Rows[DGV.Rows.Count - 1].Cells[3].Value = card_expiry_date.Text;
            }
